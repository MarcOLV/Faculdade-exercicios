            ...
            switch(tipo){
                ...
                case 4:
                    for(int i = 0; i < uni.size(); i++){
                        if (uni.get(i) instanceof Aluno){
                            JOptionPane.showMessageDialog(null, 
                                    ((Aluno)uni.get(i)).mostraClasse());
                        }else{
                            if (uni.get(i) instanceof Professor){
                                JOptionPane.showMessageDialog(null, 
                                    ((Professor)uni.get(i)).mostraClasse());
                        }else{
                                JOptionPane.showMessageDialog(null, 
                                    ((Funcionario)uni.get(i)).mostraClasse());
                            }
                        }
                    }
                    break;                 

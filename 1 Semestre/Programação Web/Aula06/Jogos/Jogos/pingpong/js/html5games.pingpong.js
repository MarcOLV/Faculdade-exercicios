...
function movePaddless()
{
	...
	if (pingpong.pressedKeys[KEY.DOWN]) // arrow down
	{
		...
		if (parseInt($("#paddleB").css("top"))+parseInt($("#paddleB").height())>=parseInt($("#playground").height()))
		{			
			$("#paddleB").css("top",parseInt($("#playground").height())-parseInt($("#paddleB").height()));
		}
		else
		{
			var top = parseInt($("#paddleB").css("top"));
	...
	if (pingpong.pressedKeys[KEY.S]) // s
	{
		...
		if (parseInt($("#paddleA").css("top"))+parseInt($("#paddleA").height())>=parseInt($("#playground").height()))
		{			
			$("#paddleA").css("top",parseInt($("#playground").height())-parseInt($("#paddleA").height()));
		}
		else
		{
			var top = parseInt($("#paddleA").css("top"));
